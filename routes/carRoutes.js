...
const insertUpdateCarDatas = ["vin_number", "car_performance", "engine_size", "technical_validity", "production_time", "color", "bodytype", "fuel", "manufacturer", "type","location_name"];
